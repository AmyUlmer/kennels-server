...
# After import get_all_animals function to _init_.py.
# Import into main module.
# Put new import statement below the existing import statement.
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        print(self.path)
        # The self.path property of the incoming request will be everything after the domain.
        ...
        # where response gets sent back using HTTP protocol to the client.
    ...
    def do_PUT(self):
        ...
        # PUT request so that employees can update status of animal
